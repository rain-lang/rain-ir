...
impl LifetimeId {
    ...
    pub(super) const NODE_DISC: usize = 0;
    /// The discriminant for abstract nodes
    pub(super) const ABSTRACT_DISC: usize = 1;
    /// The discriminant for groups
    pub(super) const GROUP_DISC: usize = 2;
    /// The number of bits shifted
    pub(super) const BITS_SHIFTED: u32 = 2;
    /// The bitmask used
    pub(super) const BITMASK: usize = (1 << Self::BITS_SHIFTED) - 1;
